...
export function initTelemetry(appContext: IAppPageContext) {
    initRuleGroupTelemetry(appContext);
    initRuleTelemetry(appContext);
}

/*
* Rule Group actions telemetry
*/
function initRuleGroupTelemetry(_appContext: IAppPageContext) {
...
*/
function initRuleTelemetry(_appContext: IAppPageContext) {
